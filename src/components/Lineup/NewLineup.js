...
import {AddLineup, RealtimeSongs, UpdateLineup} from "../../Firebase/songsApi"
...
const NewLineup = () => {
	...
	const ModalContent = () => {
		switch (open.id) {
			case "Lyrics":
				return <Lyrics setLineupData={setLineupData} song={open} lineupData={lineupData} setOpen={setOpen} />
			case "Chords":
				return <Chords setLineupData={setLineupData} song={open} lineupData={lineupData} setOpen={setOpen} />
			case "Media":
				return <Media setLineupData={setLineupData} song={open} lineupData={lineupData} />
	...
	return (
      ...
      /> */}
			...
			<Modal open={open.status} onClose={() => setOpen({id: null, status: false, song_title: null})}>
				{ModalContent()}
			</Modal>
