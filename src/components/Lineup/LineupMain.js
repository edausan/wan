...
import {Edit, Add, Save, ClearAll, Cancel, Settings} from "@mui/icons-material"
...
const Lineup = () => {
	...
	const sorted = lineups.sort((a, b) => new Date(b.date_created) - new Date(a.date_created))
	...
	return (
		<section style={{paddingBottom: 100}}>
			...
			{(currentUser?.user_metadata?.ministry === "VIA" || currentUser?.user?.email === "edausan15@gmail.com") && (
				<Link to="/lineup/new">
					<SpeedDial
