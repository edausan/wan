...
const LineupChords = ({ lineup, showChords, setShowChords }) => {
  ...
  useEffect(() => {
    ...
    lineup?.songs?.forEach((song) => {
      ...
      !exists && setSongChords((prev) => [...prev, { ...song_chord, ...song, isDone: false }]);
    });
        ...
        <div className="bg-white w-full h-full max-h-[100vh] absolute top-0 left-0 overflow-auto p-4">
          ...
          {songChords
            ...
            .map((song) => {
              ...
              return (
                <div key={song?.id} className="bg-white shadow-lg mb-4 rounded-md overflow-hidden">
                  <div
                    tabIndex={0}
                    role="button"
                  ...
                  >
                    ...
                    {pre_chorus && <Chords part="Pre-chorus" chords={pre_chorus} />}
