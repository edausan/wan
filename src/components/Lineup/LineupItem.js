						...
						action={
							<>
								...
								<PopperUnstyled
									...
									style={{zIndex: 1001}}
								>
									<Card variant="outlined" sx={{boxShadow: "md", borderRadius: "sm", p: 0}}>
										<List>
											<ListItem sx={{py: 0}}>
												<Button startIcon={<Edit fontSize="small" />} color="inherit" onClick={handleEdit}>
													Edit
												</Button>
											</ListItem>
								...
								<ListItem sx={{py: 0}}>
									...
									<ListItemText
										primary={
											<small>
												{lineup?.service}
												<div style={{color: theme.palette.text.secondary}}>{moment(lineup.date).format("LL")}</div>
											</small>
										}
			...
			>
				<Box sx={{width: 320, p: 2}}>
					...
					<List>
								...
								<ListItemText
									...
									secondary={
										<TextField
											id="verse"
											value={
												drawerData.id === "Lyrics" ? drawerData?.song?.lyrics?.verse : drawerData?.song?.chords?.verse
											}
											fullWidth
											disabled
											variant="standard"
						...
						{(drawerData?.song?.lyrics?.pre_chorus || drawerData?.song?.chords?.pre_chorus) && (
							<ListItem>
								<ListItemText
									secondary={
										<TextField
						...
						{(drawerData?.song?.lyrics?.chorus || drawerData?.song?.chords?.chorus) && (
							<ListItem>
								<ListItemText
									secondary={
										<TextField
											id="chorus"
											value={
												drawerData.id === "Lyrics" ? drawerData?.song?.lyrics?.chorus : drawerData?.song?.chords?.chorus
											}
											fullWidth
											disabled
											variant="standard"
