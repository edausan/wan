        ...
        <Grid item flex={1}>
          <Link
            ...
            style={{
              ...
              transition: theme.transitions.easing.easeInOut,
              color:
                pathname === "/assignments" ? theme.palette.primary[theme.palette.mode] : "inherit",
            }}
          >
            {false ? (
              <CircularProgress size={20} className="w-[20px] h-[20px]" />
        ...
        <Grid item flex={1}>
          <Link
            ...
            style={{
              ...
              alignItems: "center",
              transition: theme.transitions.easing.easeInOut,
              color: pathname === "/songs" ? theme.palette.primary[theme.palette.mode] : "inherit",
            }}
          >
            {false ? (
              <CircularProgress size={20} className="w-[20px] h-[20px]" />
        ...
        {/* <Grid item flex={1}>
          <Link
            ...
            style={{
              ...
              transition: theme.transitions.easing.easeInOut,
              color:
                pathname === `/chorder` ? theme.palette.primary[theme.palette.mode] : "inherit",
            }}
          >
            <AudioFileOutlined />
          </Link>
