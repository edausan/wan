                ...
                return (
                  ...
                  >
                    <ListItem>
                      ...
                      <ListItemText
                        primary={friend?.displayName ? friend?.displayName : friend?.email}
                        // secondary={
...
const Label = ({ friends, id, filter }) => {
  return (
    ...
    >
      ...
      >
        {friends.filter((f) => f.uid !== id).filter((f) => f.ministry === filter).length}
      </span>
    </span>
  );
};
...
const FriendsTab = ({ friends }) => {
  ...
  return (
    <Box sx={{ width: "100%", minHeight: 458, maxHeight: 458, overflow: "auto" }}>
