      ...
      <TabContext value={value}>
        ...
        <TabPanel value="1">
          ...
          {!isYt && ytRef.current?.value && (
            <div className="text-sm text-red-600 px-2 py-1 bg-red-50">Not a Youtube link</div>
          )}
          {isYt && ytUrl && (
            <LazyLoad>
              <iframe className="w-[100%] h-[200px]" title="test" src={ytUrl} frameborder="0" />
            </LazyLoad>
          )}
        </TabPanel>
        ...
        <TabPanel value="2">
          ...
          {!isSpotify && (
            <div className="text-sm text-red-600 px-2 py-1 bg-red-50">Not a Spotify link</div>
          )}
